...
func AbiEncodeTaskResponse(h *orderbook.IOrderBookOrderResponse) ([]byte, error) {
...
func GetTaskResponseDigest(h *orderbook.IOrderBookOrderResponse) ([32]byte, error) {
...
func ConvertToBN254G1Point(input *bls.G1Point) orderbook.BN254G1Point {
	output := orderbook.BN254G1Point{
...
func ConvertToBN254G2Point(input *bls.G2Point) orderbook.BN254G2Point {
	output := orderbook.BN254G2Point{
