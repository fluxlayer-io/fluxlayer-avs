...
func TestIntegration(t *testing.T) {
	...
	var credibleSquaringDeploymentRaw config.FluxLayerDeploymentRaw
	credibleSquaringDeploymentFilePath := "../../contracts/script/output/31337/flux_layer_avs_deployment_output.json"
	...
	config := &config.Config{
		...
		FluxLayerRegistryCoordinatorAddr: common.HexToAddress(credibleSquaringDeploymentRaw.Addresses.RegistryCoordinatorAddr),
