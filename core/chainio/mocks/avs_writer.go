...
//
//	mockgen -destination=./core/chainio/mocks/avs_writer.go -package=mocks github.com/Layr-Labs/incredible-squaring-avs/core/chainio AvsWriterer
//
...
func (m *MockAvsWriterer) RaiseChallenge(arg0 context.Context, arg1 contractOrderBook.IOrderBookOrder, arg2 contractOrderBook.IOrderBookOrderResponse, arg3 contractOrderBook.IOrderBookOrderResponseMetadata, arg4 []contractOrderBook.BN254G1Point) (*types0.Receipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockAvsWriterer) SendAggregatedResponse(arg0 context.Context, arg1 uint32, arg2 contractOrderBook.IOrderBookOrderResponse, arg3 contractOrderBook.IBLSSignatureCheckerNonSignerStakesAndSignature) (*types0.Receipt, error) {
	m.ctrl.T.Helper()
